...
- ترخيص تمليك دائم بدون اشتراكات شهرية متكررة (ادفع مرة واحدة وامتلك المنظومة للأبد).
...
المطلوب: توليد 4 نصوص تسويقية مخصصة بصيغة JSON حصراً، على النحو التالي:
{{
  "facebook": "نص فيسبوك جذاب بأسلوب القصة (Storytelling) يركز على وجع التاجر والحل الجذري، مع إيموجي وكود الخصم LAUNCH100 ورابط الموقع pos.robovai.tech وواتساب للتواصل",
  "twitter": "تغريدة تويتر (X) قوية وموجزة ومباشرة تثير الفضول مع أرقام صادمة وهاشتاجين ورابط الموقع",
  "instagram": "كابشن إنستجرام أنيق بنقاط توضيحية وإيموجي مع سؤال تفاعلي وهاشتاجات تجارية نشطة (#كاشير #مطاعم #سوبرماركت #POS)",
  "telegram": "رسالة قناة تليجرام موجهة لأصحاب الأعمال بعناوين عريضة ورابط مباشر للواتساب وكود LAUNCH100"
}}
